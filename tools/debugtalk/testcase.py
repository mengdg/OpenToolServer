...
from tools.debugtalk import exceptions, logger, utils
from tools.debugtalk.compat import (OrderedDict, basestring, builtin_str, numeric_types, str)
from tools.debugtalk.utils import FileUtils
...
def parse_parameters(parameters, testset_path=None, variables=None):
    ...
    """
    testcase_parser = TestcaseParser(variables=variables, file_path=testset_path)
    ...
    for parameter in parameters:
        ...
        if isinstance(parameter_content, list):
            ...
            if isinstance(parsed_parameter_content, (str, int, list, dict, float, bytes, bool)):
                return parsed_parameter_content
            elif parsed_parameter_content == None:
                return []
            else:
