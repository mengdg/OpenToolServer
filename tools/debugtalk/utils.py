...
import yaml
from tools.debugtalk import exceptions, logger
from tools.debugtalk.compat import OrderedDict, basestring, is_py2, is_py3, str
...
class FileUtils(object):
    ...
    def _load_yaml_file(yaml_file):
        ...
        with io.open(yaml_file, 'r', encoding='utf-8') as stream:
            # 通过禁止默认加载程序（FullLoader）执行任意功能，该load函数也变得更加安全
